...
import com.example.notepadapp.navigation.SetupUserPageNavGraph
...
@Composable
fun MainPageWithBottomSheetMenu(
) {
    ...
    Box(Modifier.fillMaxSize().background(CustomAppTheme.colors.mainBackground)) {
        Box(Modifier.fillMaxSize()){
            SetupUserPageNavGraph(navController = navController, startDestination = UserPage.Settings.route)
        }
        Box(
            Modifier
